...
../../TOOLS/makeCompositeBinary/makeCompositeBinary -i build/output_files/$PROJECT_NAME.ttf:1:512,build/output_files/$PROJECT_NAME.bin:0:896 -o build/output_files/app.ttf -t 1 >output_files/signature.h
else
