...
# Create a new driver
create_driver QUAD_ENCODER

# Associate it with some hardware known as "QUAD_ENCODER"
set_sw_property hw_class_name QUAD_ENCODER
...
# C/C++ source files
add_sw_property c_source src/enc.c

# Include files
add_sw_property include_source inc/enc.h
