...
# Create a new driver
create_driver o_i2c_master

# Associate it with some hardware known as "o_i2c_master"
set_sw_property hw_class_name o_i2c_master
...
# C/C++ source files
add_sw_property c_source src/i2c.c

# Include files
add_sw_property include_source inc/i2c.h
